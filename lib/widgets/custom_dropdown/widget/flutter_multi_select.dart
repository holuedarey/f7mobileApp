...
import 'package:f7apparel_mobile/widgets/custom_dropdown/widget/flutter_multiple_custom_selector_sheet.dart';
import '../utils/enum.dart';
import '../utils/flutter_custom_select_item.dart';
import '../utils/utils.dart';

class CustomMultiSelectField<T> extends StatefulWidget
    with MultipleCustomBottomSheetSelector<T> {
  final double? width;
  final String title;
        ...
        GestureDetector(
          onTap: () async {
            Map<String, List<T>?> result =
                await MultipleCustomBottomSheetSelector<T>().customBottomSheet(
