...
import 'package:f7apparel_mobile/blocs/registration/sign_up_cubit.dart';
import 'package:f7apparel_mobile/myapp.dart';
import 'package:f7apparel_mobile/widgets/back_button.dart';
...
class _SignUpEmailPasswordPageState extends State<SignUpEmailPasswordPage> {
  ...
  void _onSignUpEmailPasswordButtonPressed() {
    ...
    if (signUpEmailPasswordFormKey.currentState!.validate()) {
      ...
      context.read<SignUpCubit>().registerUser(parameters);
    }
  }
                    ...
                    ListTile(
                      ...
                      subtitle: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          // contentPadding: EdgeInsets.fromLTRB(16.w, 24.h, 16.w, 24.h),
